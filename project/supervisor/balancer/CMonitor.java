...
public class CMonitor {
    ...
    * */
     ...
     * TODO: Careful with deadlock generated by Endpoint compareTo.
     * */
    static Endpoint decide(String s, LoadBalancer.Request request, boolean persist) throws InterruptedException {
    ...
    static class Endpoint extends Thread implements Comparable<Endpoint> {
        ...
        private Socket sc;
        private final ConcurrentSkipListMap<String,LoadBalancer.Request> rcache =
